...
<div class="container-fluid">
    <div class="card shadow mb-4">
        ...
        <c:if test="${errMsg != null}">
            ...
            <form:form action = "/phongmachtu/create-medicine" enctype="multipart/form-data" method="post" modelAttribute="thuoc" class="row form-group col-xl-12 ">
                ...
                <div class="form-group col-sm-3">
                    <div>
                        ...
                        <form:input path="tenThuoc" class="form-control"/>
                         <form:errors path="tenThuoc" cssClass="alert-danger" element="div"/>
                    </div>
                    <div class="my-4">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <div class="my-4">
                        ...
                        <form:errors path="soLuong" cssClass="alert-danger" element="div"/>
                    </div>
                </div>
                <div class="form-group col-sm-2">
                    <div>
                        <label for="date">Hạn sử dụng<span class="text-danger">*</span></label>
                        <form:input type="date"   path="hanSuDung" id="hanSuDung" class="form-control"/>
                         
                    </div>
                    <div class="my-4">
                        <label for="gia">Giá bán<span class="text-danger">*</span></label>
                        <form:input path="giaBan" class="form-control"/><span></span>
                         <form:errors path="giaBan" cssClass="alert-danger" element="div"/>
                    </div>
                </div>
